 ...
 * @author raulpenate
 */
public class SectorPrimario extends Empresa {

    private String grado;
    private String tamaño;
    private String formaJurdica;

    public SectorPrimario(String nombre, String headquarters, String CEO, String mercado, String grado, String tamaño, String formaJuridica) {
