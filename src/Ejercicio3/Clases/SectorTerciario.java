 ...
 * @author raulpenate
 */
public class SectorTerciario extends Empresa {

    private String grado;
    private String tamaño;
    private String formaJurdica;

    public SectorTerciario(String nombre, String headquarters, String CEO, String mercado, String grado, String tamaño, String formaJuridica) {
